...
type SpecValidator struct {
	Name     string
	Validate func(*k8sfield.Path, *v1.VirtualMachineInstanceSpec, *virtconfig.ClusterConfig) []metav1.StatusCause
}
...
func (admitter *VMICreateAdmitter) Admit(_ context.Context, ar *admissionv1.AdmissionReview) *admissionv1.AdmissionResponse {
	...
	for _, validateSpec := range admitter.SpecValidators {
		causes = append(causes, validateSpec.Validate(k8sfield.NewPath("spec"), &vmi.Spec, admitter.ClusterConfig)...)
	}
